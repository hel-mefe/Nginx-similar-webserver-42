// #include "../includes/select.class.hpp"
...
// void    Select::write_error(const std::string err_msg)
// {
//     std::cout << CYAN_BOLD << "[webserv42]: " << err_msg << std::endl;
//     exit(1);
// }

// struct sockaddr_in *Select::getsocketdata(PORT port)
// {
...
// SOCKET Select::getsocketfd(int port)
// {
//     struct sockaddr_in *data;
//     socklen_t data_len;
//     socklen_t oplen = 1;
...
// void    Select::set_manager()
// {
//     t_manager *_manager = new t_select_manager();
...
//     _manager->fds = new struct Selectfd[MAX_FDS]();
...
// void Select::handle_connection(t_manager *manager, SOCKET fd)
// {
...
// void Select::handle_disconnection(t_manager *manager, SOCKET fd)
// {
//     (void)manager;
...
// void Select::handle_client(t_manager *manager, SOCKET fd)
// {
